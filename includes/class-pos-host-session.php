 ...
 * POS_HOST_Session.
 */
class POS_HOST_Session extends WC_Data {
	...
	public function __construct( $data = '' ) {
		...
		if ( $data instanceof POS_HOST_Session ) {
	...
	/**
	 * Developers can programmatically return sessions. This function will read those values into our POS_HOST_Session class.
	 *
	 * @param string $slug    Session slug.
