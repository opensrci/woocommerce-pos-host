...
<tr class="item <?php echo esc_attr( $class ); ?> item_<?php echo esc_attr( $item_id ); ?>" data-prid="<?php echo esc_attr( $item_id ); ?>" data-parentid="<?php echo esc_attr( $parent_id ); ?>" >
	...
	<td class="name">
		...
		if ( $_product->is_type( 'variation' ) ) {
			echo '<div class="wc-order-item-variation"><strong>' . esc_html__( 'Variation ID:', 'woocommerce-pos-host' ) . '</strong> ';
	...
	<td class="quantity" width="1%">
		...
		<div class="edit" style="display: none;">
			<?php $item_qty = 1; ?>
			<input type="number" step="<?php echo esc_attr( apply_filters( 'woocommerce_quantity_input_step', '1', $_product ) ); ?>" min="1" autocomplete="off" placeholder="1" value="1" size="4" class="quantity" />
		</div>
	</td>
	...
	<td class="wc-order-edit-line-item" width="1%">
		<div class="wc-order-edit-line-item-actions">
			<a class="edit-order-item tips" href="#" data-tip="<?php esc_attr_e( 'Edit item', 'woocommerce-pos-host' ); ?>"></a>
			<a class="delete-order-item tips" href="#" data-tip="<?php esc_attr_e( 'Delete item', 'woocommerce-pos-host' ); ?>"></a>
		</div>
	</th>
</tr>
