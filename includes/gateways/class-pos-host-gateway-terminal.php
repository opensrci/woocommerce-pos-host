...
class POS_HOST_Gateway_Terminal extends WC_Payment_Gateway {
	...
	protected function setup_properties() {
		...
		$this->method_title       = sprintf( __( 'Terminal %s', 'woocommerce-pos-host' ), $this->process_gateway_number( self::$number ) );
		$this->method_description = __( 'Terminal payment gateway.', 'woocommerce-pos-host' );
	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'description'              => array(
				...
				'default'     => __( 'Pay via Terminal.', 'woocommerce-pos-host' ),
				'desc_tip'    => true,
			),
