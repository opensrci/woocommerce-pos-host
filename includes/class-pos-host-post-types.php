		...
		if ( ! post_type_exists( 'pos_host_outlet' ) ) {
			register_post_type(
				...
				apply_filters(
					...
					array(
						'labels'              => array(
							'name'                  => __( 'Locations', 'woocommerce-pos-host' ),
							'singular_name'         => __( 'Location', 'woocommerce-pos-host' ),
							'all_items'             => __( 'Locations', 'woocommerce-pos-host' ),
							'menu_name'             => _x( 'Locations', 'Admin menu name', 'woocommerce-pos-host' ),
							'add_new'               => __( 'Add New', 'woocommerce-pos-host' ),
							...
							'featured_image'        => __( 'Location image', 'woocommerce-pos-host' ),
							...
							'items_list_navigation' => __( 'Locations navigation', 'woocommerce-pos-host' ),
							'items_list'            => __( 'Locations list', 'woocommerce-pos-host' ),
						),
