...
final class PH_Cloner_Request {
	 ...
	 * @var string
	 */
	private static $option_key = 'ph_cloner_saved_request';
	...
	public function refresh() {
		$this->request = (array) get_site_option( 'ph_cloner_saved_request', [] );
		return $this;
	}
 ...
 * @return PH_Cloner_Request
 */
function ph_cloner_request() {
	return PH_Cloner_Request::instance();
}
